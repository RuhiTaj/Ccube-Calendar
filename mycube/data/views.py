...
def detail(request, date):
    allcompetitions = Competitions.objects.all()
    time = date[0:4]+'-'+date[4:6]+'-'+date[6:8]
    return render(request, 'calendardata/detail.html' , {  'competitions' : allcompetitions, 'timing'       : time} )

    # for the_competition in allcompetitions:   
    ...
    # if p == 0:
    #     html = 'Oops! This date does not have any competitions'
    #     return HttpResponse(html)
    # else:
    #     return HttpResponse(html)
...
#
    c = Competitions() 
    c.codingLink = "https://www.hackerrank.com/contests/projecteuler/challenges"
    c.websiteName = "hackerrank"
    c.compName = "Project_Euler"
    c.startDate = "2005-01-01"
    c.endDate = "2050-08-08"
    c.startTime = "-"
    c.endTime = "-"
    ...
    c = Competitions() 
    c.codingLink = "https://www.codechef.com/INOIPRAC"
    c.websiteName = "codechef"
    c.compName = "INOI Practice Contest"
    c.startDate = "2016-01-05"
    c.endDate = "2020-01-05"
    c.startTime = "00:00 AM"
    c.endTime = "00:00 AM"
    c.duration = "Four years"
    c.save()
...
#     c = Competitions() 
#     c.codingLink = "https://www.codechef.com/ZCOPRAC"
#     c.websiteName = "codechef"
#     c.compName = "ZCO Practice Contest"
#     c.startDate = "2015-11-05"
#     c.endDate = "2018-01-05"
#     c.startTime = "00:00 AM"
#     c.endTime = "00:00 AM"
#     c.duration = "-"
#     c.save()
